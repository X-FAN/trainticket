...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView iv = (ImageView) findViewById(R.id.check_code_image);
//        Picasso.setSingletonInstance(new Picasso.Builder(this).downloader(new OkHttpDownloader(RetrofitUtils.getClient(this))).build());
        ...
        picasso.load("https://kyfw.12306.cn/otn/passcodeNew/getPassCodeNew?module=login&rand=sjrand").into(iv, new Callback() {
            @Override
